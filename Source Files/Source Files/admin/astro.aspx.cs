...
public partial class _Default : System.Web.UI.Page
{
    ...
    {
        string query = "Select * from astro where status='Completed'";
    ...
    {
        string query = "Select * from astro where status='Pending'";
    ...
    protected void btnPendingStats_Click(object sender, EventArgs e)
    {
        ...
        {
            UpdateQuery = "Update astro set status = '" + ddlstatuspending.SelectedValue + "' where id='" + hidValuCartId.Value + "'";
        }
        else
        {
            UpdateQuery = "Update astro set status='" + ddlstatuspending.SelectedValue + "' where id='" + hidValuCartId.Value + "'";
