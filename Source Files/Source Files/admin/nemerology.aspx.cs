...
public partial class _Default : System.Web.UI.Page
{
    ...
    {
        string query = "Select * from numerology where status='Completed'";
    ...
    {
        string query = "Select * from numerology where status='Pending'";
    ...
    private DataTable getshporders(string query)
    {
        ...
        temp.Columns.Add("id");
        temp.Columns.Add("dob");
        temp.Columns.Add("tob");
        temp.Columns.Add("pob");
        ...
        {
            temp.Rows.Add(dr.ItemArray[0].ToString(),dr.ItemArray[1].ToString(), dr.ItemArray[2].ToString(), dr.ItemArray[3].ToString(), dr.ItemArray[4].ToString(), dr.ItemArray[5].ToString(), dr.ItemArray[6].ToString());
        }
    ...
    protected void btnPendingStats_Click(object sender, EventArgs e)
    {
        ...
        {
            UpdateQuery = "Update numerology set status = '" + ddlstatuspending.SelectedValue + "' where id='" + hidValuCartId.Value + "'";
        }
        else
        {
            UpdateQuery = "Update numerology set status='" + ddlstatuspending.SelectedValue + "' where id='" + hidValuCartId.Value + "'";
