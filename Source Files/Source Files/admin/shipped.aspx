    <%@ Page Language="C#" AutoEventWireup="true" CodeFile="shipped.aspx.cs" Inherits="_Default" %>
       ...
       <div class="container" style="margin-top: 0px; margin-bottom: 0px">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading">Shippped Orders</div>
                    ...
                    <div class="panel-body">
                        ...
                        <asp:Panel ID="pnlPendingStatus" runat="server" CssClass="panel" Width="100%" Height="100%">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label for="lblshippdate">Order Delivered</label>
                                    <asp:DropDownList ID="txtShipDate" CssClass="form-control" runat="server">
