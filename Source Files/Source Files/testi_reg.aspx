<%@ Page Language="C#" AutoEventWireup="true" CodeFile="testi_reg.aspx.cs" Inherits="_Default" %>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel col-md-offset-2 col-md-8 col-md-offset-2  ">
                       <%-- <div class="panel-heading"><span class="glyphicon glyphicon-apple"></span><span style="color: #ff6a00"><b>ADDRESS BOOK</b></span></div>--%>
                       <div class="panel-heading">
                        <span style="font-size:x-large">Submit your Testimonial</span>
                       </div>
                        <div class="panel-body">
                           <div class="form-group-sm">
                               <label for="orderid" runat="server">Enter your <b>Name</b></label>
                               <asp:TextBox ID="txtName" runat="server" CssClass="form-control"></asp:TextBox>
                           </div>
                             <div class="form-group-sm">
                               <label for="orderid" runat="server">Enter your <b>Email Id</b></label>
                               <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control"></asp:TextBox>
                           </div>
                            <div class="form-group-sm">
                               <label for="orderid" runat="server">Enter your <b>Comments</b></label>
                               <asp:TextBox ID="txtCmnts" runat="server" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
                           </div>
                            <br />
                           <div id="warning" runat="server"></div>
                        </div>
                        <div class="panel-footer">
                            <asp:Button ID="btnsubmit" Text ="Submit" OnClick="btnsubmit_Click" runat="server" /><asp:Label ID="lblMsg" runat="server" CssClass="label label-success"></asp:Label>
                        </div>
                    </div>
