<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add_man.aspx.cs" Inherits="_Default" %>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="page-header" style="background-color: #5610FA; margin-top: -20px" id="account_dashboard">
                        <h2><small style="color: white">&nbsp;&nbsp;Manage Addresses</small></h2>
                    </div>
                    <div style="margin-top: -15px">
                        <asp:LinkButton ID="lbtnGoBack" runat="server" OnClick="lbtnGoBack_Click"><span class="glyphicon glyphicon-arrow-left"></span>Go Back</asp:LinkButton>
                    </div>
                    <div class="panel">
                        <div class="panel-heading"><span class="glyphicon glyphicon-apple"></span><span style="color: #ff6a00"><b>ADDRESS BOOK</b></span></div>
                        <div class="panel-body">
                            <asp:GridView ID="grdAddr" runat="server" HorizontalAlign="Center" OnRowCommand="grdAddr_RowCommand" AutoGenerateColumns="False" AllowPaging="True" DataKeyNames="id" CssClass="table table-hover table-bordered">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="user_mail" HeaderText="UserMail" Visible="false" />
                                    <asp:BoundField DataField="user_address1" HeaderText="Address1" />
                                    <asp:BoundField DataField="user_address2" HeaderText="Address2" />
                                    <asp:BoundField DataField="user_city" HeaderText="City" />
                                    <asp:BoundField DataField="user_state" HeaderText="State" />
                                    <asp:BoundField DataField="user_country" HeaderText="Country" />
                                    <asp:BoundField DataField="user_pincode" HeaderText="Pin" />
                                    <asp:BoundField DataField="user_mobile" HeaderText="Mobile" />
                                    <asp:CheckBoxField DataField="user_make_as_default" HeaderText="Default Address" />
                                    <asp:CheckBoxField DataField="user_make_as_shipping" HeaderText="Default Shipping" />
                                </Columns>
                            </asp:GridView>


                            <asp:HiddenField ID="hidForAddrEdit" runat="server" />
                            <cc1:ModalPopupExtender ID="updateModal" TargetControlID="hidForAddrEdit" runat="server" CancelControlID="btnClose" DropShadow="true" PopupControlID="editModal"></cc1:ModalPopupExtender>
                                ...
                                <div class="modal-body">
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtModalAdd1Edit" runat="server"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td>Address Line 2 :</td>
                                            <td>
                                                <asp:TextBox ID="txtModalAdd2Edit" runat="server"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>City :</td>
                                            <td>
                                                <asp:TextBox ID="txtModalCityEdit" runat="server"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td>State :</td>
                                            <td>
                                                <asp:TextBox ID="txtModalStateEdit" runat="server"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td>Country :</td>
                                            <td>
                                                <asp:TextBox ID="txtModalCountryEdit" runat="server"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td>Pincode :</td>
                                            <td>
                                                <asp:TextBox ID="txtModalPinEdit" runat="server"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td>Mobile :</td>
                                            <td>
                                                <asp:TextBox ID="txtModalMobileEdit" runat="server"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td>Default Address :</td>
                                            <td>
                                                <asp:CheckBox ID="chkModalDefEdit" runat="server" /></td>
                                        </tr>
                                        <tr>
                                            <td>Default Shipping :</td>
                                            <td>
                                                <asp:CheckBox ID="chkModalShipEdit" runat="server" /></td>
                                        </tr>
                                    </table>
                                </div>
                                <div class="modal-footer">
                                    <asp:Label ID="lblResult" Visible="false" runat="server"></asp:Label>
                                    <asp:Button ID="btnSave" runat="server" Text="Update" CssClass="btn btn-info" OnClick="btnSave_Click" CausesValidation="False" />
