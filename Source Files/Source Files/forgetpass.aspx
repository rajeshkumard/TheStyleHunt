<%@ Page Language="C#" AutoEventWireup="true" CodeFile="forgetpass.aspx.cs" Inherits="_Default" %>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel col-md-offset-4 col-md-4 col-md-offset-4">
                       <%-- <div class="panel-heading"><span class="glyphicon glyphicon-apple"></span><span style="color: #ff6a00"><b>ADDRESS BOOK</b></span></div>--%>
                       <div class="panel-heading">
                        <span style="font-size:x-large">Forget Password</span>
                       </div>
                        <div class="panel-body">
                           <div class="form-group-sm">
                               <label for="orderid" runat="server">Enter your <b>Email Id</b></label><br /><br />
                        ...
                        <div class="panel-footer">
                            <asp:Button ID="btnSendPassword" Text ="Send my Password" runat="server" OnClick="btnSendPassword_Click" />
                        </div>
                    </div>
