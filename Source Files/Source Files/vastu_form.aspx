<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vastu_form.aspx.cs" Inherits="_Default" %>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                           ...
                           <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label for="dob">Blueprint of Place</label>
                                   <asp:FileUpload ID="fileUp1" runat="server" AllowMultiple="true" CssClass="form-control" />
                                </div>
                            </div>
