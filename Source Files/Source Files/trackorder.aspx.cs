    ...
    protected void Page_Load(object sender, EventArgs e)
{
    ...
    {
        string status = _support.getValue("Select cart_status from cart_shop where cart_Id ='" + txtOrderId.Text + "'");
        if (status.ToLower() == "approved")
        {
            imgTrack.ImageUrl = "../images/workflow/approval.PNG";
            
        }
        else if (status.ToLower() == "processed")
        {
            imgTrack.ImageUrl = "../images/workflow/processing.PNG";
           
        }
        else if (status.ToLower() == "shipped")
        {
            imgTrack.ImageUrl = "../images/workflow/shipping.PNG";
          
        }
        else if (status.ToLower() == "delivered")
        {
            imgTrack.ImageUrl = "../images/workflow/delivery.PNG";
