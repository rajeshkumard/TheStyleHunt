<%@ Page Language="C#" AutoEventWireup="true" CodeFile="failureHandler.aspx.cs" Inherits="_Default" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                       ...
                       <div class="panel-heading">
                        <span style="font-size:x-large">Your order was not placed completely.</span>
                       </div>
                        <div class="panel-body">

                            <h4>Oops, Your Order ID is : <asp:Label ID="lblorderId" runat="server" CssClass="label label-success"></asp:Label>. Kindly make note of it for further assistance.</h4>
