<%@ Page Language="C#" AutoEventWireup="true" CodeFile="testimonial.aspx.cs" Inherits="_Default" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                       ...
                       <div class="panel-heading">
                        <span class="col-md-10" style="font-size:x-large">Testimonials</span>
                                <asp:Button ID="btnSubmitTestimonial" runat="server" Text="Submit Testimonial" OnClick="btnSubmitTestimonial_Click" CssClass="btn btn-warning" />
                       </div>
                        <div class="panel-body">
                            
                            <div><br />
                                <asp:DataList ID="dataTesti" Width="100%" runat="server" RepeatColumns="1" RepeatDirection="Horizontal" DataKeyField="id" DataSourceID="SqlDataSource1" AlternatingItemStyle-CssClass="alert alert-success" ItemStyle-CssClass="alert alert-warning">
                                    <ItemTemplate>

                                            <div class="text-left">
                                                <asp:Label Text='<%# Eval("test_name") %>' runat="server" ID="test_nameLabel" />&nbsp;Says:<br />
                                                <asp:Label Text='<%# Eval("test_date") %>' runat="server" ID="test_dateLabel" /><br />
                                            </div>
                                            <div class="text-center">
                                                <asp:Literal Text='<%# Eval("test_messg") %>' runat="server" ID="test_messgLabel" /><br />
                                            </div>
                                ...
                                <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:project16ConnectionString %>' SelectCommand="SELECT * FROM [testimonial]"></asp:SqlDataSource>
                            </div>
