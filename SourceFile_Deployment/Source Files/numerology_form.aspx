<%@ Page Language="C#" AutoEventWireup="true" CodeFile="numerology_form.aspx.cs" Inherits="_Default" %>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="page-header" style="background-color: #5610FA; margin-top: -20px" id="account_dashboard">
                        <h2><small style="color: white">&nbsp;&nbsp;Astrology</small></h2>
                    </div>
                    
                    <div class="panel">
                        <div class="panel-heading"><span class="glyphicon glyphicon-apple"></span><span style="color: #ff6a00"><b>Registration Form</b></span></div>
                        <div class="panel-body">
                            <div class="col-md-offset-4 col-md-4 col-md-offset-4">
                                ...
                                <div class="form-group">
                                    <label for="dob">Time of Birth</label>
                                    <asp:TextBox ID="txttob" TextMode="Time" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="panel-footer">
                            <asp:Button ID="btnRegister" OnClick="btnRegister_Click" runat="server" Text="Register" CssClass="btn btn-success" /><asp:Label ID="lblmsg" runat="server" CssClass="label label-success"></asp:Label>
                        </div>
                    </div>
