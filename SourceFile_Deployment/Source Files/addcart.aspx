...
<body style="background-image: url('../images/bgpattern.PNG'); background-repeat: repeat">
    <form runat="server">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="testimonial.aspx" style="visibility: hidden; font-size: small; color: white">Testimonials</a></li>
                    </ul>
                    ...
                    <div class="navbar-form navbar-right">
                        ...
                        <div class="form-group">
                            <asp:Button ID="lbtnReg" CssClass="btn btn-warning btn-sm" runat="server" Visible="false" Text="Register" OnClick="lbtnReg_Click" />
                            <asp:Button ID="lbtnLog" runat="server" CssClass="btn btn-warning btn-sm" Visible="false" Text="Login" OnClick="lbtnLog_Click" />
        ...
        <div class="container" style="margin-bottom: -20px; margin-top: 0px">
            ...
            <asp:Menu ID="headerMenu" runat="server" BackColor="#5610FA" DynamicHorizontalOffset="2" StaticEnableDefaultPopOutImage="false" 
                OnMenuItemClick="headerMenu_MenuItemClick" Font-Names="Verdana" Font-Size="Large" ForeColor="White" StaticSubMenuIndent="10px" 
                Orientation="Horizontal" StaticMenuItemStyle-BorderStyle="Solid" StaticMenuStyle-BorderStyle="None" StaticHoverStyle-BorderStyle="None">
                <DynamicHoverStyle BackColor="#990000" ForeColor="White"></DynamicHoverStyle>

                <DynamicMenuItemStyle HorizontalPadding="5px" VerticalPadding="1px" Font-Size="Small"></DynamicMenuItemStyle>
        ...
        <asp:UpdatePanel ID="pnl1" runat="server">
            <ContentTemplate>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div style="color: white; background-color: #5610FA">
                                &nbsp;&nbsp;&nbsp;<span style="font-size: large">Shopping Cart</span>
                            </div>
                        ...
                        <div class="col-md-offset-8 col-md-4 text-right">
                            <div class="panel" style="background-color: rgba(235, 109, 147, 0.21)">
                                <div class="panel-body">
                                    ...
                                    <br />
                                    <span style="font-size: medium">Shipping Charge </span>&nbsp;&nbsp;&nbsp;
                                    <asp:Label ID="Label1" Font-Size="Medium" CssClass="label label-success" runat="server" Text="Rs.0"></asp:Label><hr />
                                    <span style="font-size: larger">Grand Total </span>&nbsp;&nbsp;&nbsp;
                                    <asp:Label ID="Label4" Font-Size="Large" CssClass="label label-success" runat="server" Text="Rs.0"></asp:Label>
              ...
              <asp:Button runat="server" CssClass="btn btn-warning" ID="btnCloseAddr" Text="Close"></asp:Button><asp:Label ID="lblAddrMsg" runat="server" CssClass="label label-danger"></asp:Label>
                                                    </div>
                                                </asp:Panel>
                                        ...
                                        <Content>
                                            <div class="panel">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group">
                                                        <asp:RadioButton ID="rbnChkCOD" AutoPostBack="true" OnCheckedChanged="rbnChkCOD_CheckedChanged" runat="server" Text="Cash On Delivery" GroupName="pay_method" /><br />
                                                        <asp:TextBox ID="lblChkCOD" runat="server" Visible="false"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </Content>
                                            ...
                                            <div class="panel">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="text-right col-md-offset-8 col-md-4" style="background-color: #f6b2c6">
                                                        ...
                                                        You will earn :
                                                        <asp:Label ID="lblyouWill" runat="server" Font-Size="Larger"></asp:Label>
                                                        points<hr />
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="panel" style="font-size: medium; color: black">
                            ...
                            <br />
                            <div>&nbsp;&nbsp;<span class="glyphicon-alert gly-spin"></span>&nbsp;&nbsp;<a href="#" style="color: black">Privacy Policy</a></div>
                            <br />
                            <div>&nbsp;&nbsp;<span class="glyphicon-alert gly-spin"></span>&nbsp;&nbsp;<a href="#" style="color: black">Shipping Policy</a></div>
                            <br />
                            <div>&nbsp;&nbsp;<span class="glyphicon-alert gly-spin"></span>&nbsp;&nbsp;<a href="#" style="color: black">Return Policy</a></div>
                            <br />
                            <div>&nbsp;&nbsp;<span class="glyphicon-alert gly-spin"></span>&nbsp;&nbsp;<a href="#" style="color: black">Terms & Conditions</a></div>
                            <br />
                    ...
                    <div class="col-md-4">
                        ...
                        <br />
                        <div class="panel" style="font-size: medium; color: black">
                            <div>&nbsp;&nbsp;<span class="glyphicon glyphicon-star-empty gly-spin"></span>&nbsp;&nbsp;<a style="color: black" href="#">Sign In</a></div>
                            <br />
                            <div>&nbsp;&nbsp;<span class="glyphicon glyphicon-star-empty gly-spin"></span>&nbsp;&nbsp;<a style="color: black" href="#">View Cart</a></div>
                            <br />
                            <div>&nbsp;&nbsp;<span class="glyphicon glyphicon-star-empty gly-spin"></span>&nbsp;&nbsp;<a style="color: black" href="#">Track Your Order</a></div>
                            <br />
