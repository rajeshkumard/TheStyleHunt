    ...
    protected void Page_Load(object sender, EventArgs e)
{
    ...
    protected void btnRegister_Click(object sender, EventArgs e)
    {
        ...
        string insertQuery = "Insert into astro (dob,tob,pob,name,email,mobile,status) values ('" + txtdob.Text + "','" + txttob.Text + "','" + txtpob.Text + "','"+txtName.Text+"','"+txtemail.Text+"','"+txtMobile.Text+"','Pending')";
        string res = _support.insertQuery(insertQuery);
        if(res.ToLower()=="true")
        {
            string subct = "Predict Numerology For Mr." + txtName.Text;
            StringBuilder sb = new StringBuilder();
            sb.AppendLine("Name : " + txtName.Text);
            sb.AppendLine("DOB : " + txtdob.Text);
            sb.AppendLine("TOB : " + txttob.Text);
            sb.AppendLine("POB :" + txtpob.Text);
            ...
            //_support.sendmail("contact.srijothedam@gmail.com", subct,sb.ToString());
