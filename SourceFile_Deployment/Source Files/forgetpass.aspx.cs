    ...
    protected void Page_Load(object sender, EventArgs e)
{
    ...
    {
        string pass = _support.Decrypt(_support.getValue("Select user_pass from user_info where user_mail='" + txtEmailId.Text + "'"));
        if(pass!="")
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendLine("User Name :"+txtEmailId.Text);
            sb.AppendLine("<br />Password :" + pass);
            sb.AppendLine("<br /><br /><h6>Note:Kindly delete this mail for security purpose</h6><br /><br />Regards,<br />Srijothedam Team.");
            //_support.sendmail(txtEmailId.Text, "Your Password", sb.ToString());
            warning.Attributes.Add("class", "alert alert-success");
            warning.Attributes.Add("role", "alert");
            warning.InnerText = "Your Password is sent your registered Email Address...!";
        }
        else
        {
            warning.Attributes.Add("class", "alert alert-danger");
            warning.Attributes.Add("role", "alert");
            warning.InnerText = "No such user found ... Try Again ...!";
        }
    }
}