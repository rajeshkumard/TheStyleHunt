    ...
    <form runat="server">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    ...
                    <div class="navbar-form navbar-right">
                        ...
                        <div class="form-group">
                            <asp:Button ID="lbtnReg" CssClass="btn btn-warning btn-sm" runat="server" Text="Register" Visible="false" OnClick="lbtnReg_Click" />
                            <asp:Button ID="lbtnLog" runat="server" CssClass="btn btn-warning btn-sm" Text="Login" Visible="false" OnClick="lbtnLog_Click" />
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-3 col-md-offset-2 col-md-2 text-center">
                                    <br />
                                    <asp:Menu ID="Menu1" runat="server" CssClass="abc img-rounded" Font-Bold="true" 
                                        BackColor="#FFFBD6" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="Large" 
                                        ForeColor="#990000" StaticEnableDefaultPopOutImage="false" StaticSubMenuIndent="10px">
        ...
        <div class="container" style="margin-bottom: -20px; margin-top: 0px">
            ...
            <asp:Menu ID="headerMenu" runat="server" BackColor="#5610FA" DynamicHorizontalOffset="2" StaticEnableDefaultPopOutImage="false" 
                OnMenuItemClick="headerMenu_MenuItemClick" Font-Names="Verdana" Font-Size="Large" ForeColor="White" Font-Bold="false" StaticSubMenuIndent="10px" 
