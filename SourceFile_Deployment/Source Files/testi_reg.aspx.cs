    ...
    protected void Page_Load(object sender, EventArgs e)
{
    ...
    {
        if (txtName.Text != "" && txtCmnts.Text != "")
        {
            string insertQuery = "Insert into testimonial (test_name,test_email,test_messg,test_date) values ('" + txtName.Text + "','" + txtEmail.Text + "','" + txtCmnts.Text + "','" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "')";
            string res = _support.insertQuery(insertQuery);
            if (res.ToLower() == "true")
            {
                clear();
                lblMsg.Text = "Your Testimonial Submitted Successfully...!";
        ...
        {
            lblMsg.Text = "Please enter your name and Comment";
