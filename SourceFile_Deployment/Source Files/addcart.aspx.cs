...
public partial class addcart : System.Web.UI.Page
{
    ...
    protected void rbnChkCOD_CheckedChanged(object sender, EventArgs e)
    {
        if (rbnChkCOD.Checked == true)
        {
            lblPauymoney.Visible = false;
            lblBanktra.Visible = false;
            lblChkCOD.Visible = true;
            lblChkCOD.TextMode = TextBoxMode.MultiLine;
            lblChkCOD.ReadOnly = true;
            lblChkCOD.Text = "Currently we are supporting Cash only";
        }
    }
    protected void btnFinalSubmit_Click(object sender, EventArgs e)
    {
        ...
        else if (pay_method == "rbnChkCOD")
        {
            pay_details = lblChkCOD.Text;
        }
        string ship_method = getRadioValue(this.Controls, "cori_method");
