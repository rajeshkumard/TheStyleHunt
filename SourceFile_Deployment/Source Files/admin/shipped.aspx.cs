...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void btnPendingStats_Click(object sender, EventArgs e)
    {
        ...
        if(ddlstatuspending.SelectedValue.Equals("Delivered"))
        {
            string sta = string.Empty;
            UpdateQuery = "Update cart_shop set cart_product_recieved = '" + txtShipDate.SelectedValue + "',cart_status='" + ddlstatuspending.SelectedValue + "' where cart_Id='" + hidValuCartId.Value + "'";
        }
        else
        {
